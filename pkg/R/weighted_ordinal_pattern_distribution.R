...
#' @usage weighted_ordinal_pattern_distribution(x, ndemb, weight.fun)
...
#' @param weight.fun Function to weight each pattern accordin to a user-specified function. This function must return one value. Default is to 'var.fun', which generates variance-based weights (see Fadlallah et al 2013).
#' @details 
...
weighted_ordinal_pattern_distribution = function(x, ndemb, weight.fun = var.fun) {
